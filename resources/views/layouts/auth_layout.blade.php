...
<head>
    ...
    <meta name="description" content="تسجيل دخول لوحة تحكم مكاتب الحج والعمرة">
    <meta name="author" content="abod">
    <title> مكاتب الحج والعمرة | تسجيل الدخول</title>
...
<body class="rtl vertical-layout vertical-menu 1-column bg-cyan bg-lighten-2 blank-page" data-open="click"
    data-menu="vertical-menu" data-col="1-column" style="background-color: #03872899 !important">
    <div id="app">
