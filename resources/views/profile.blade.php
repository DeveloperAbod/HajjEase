...
@section('page_meta')
    ...
    <title>
        لوحة تحكم مكاتب الحج والعمرة | الملف الشخصي
    </title>
@endsection
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <ul class="nav nav-tabs mb-2" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link d-flex align-items-center text-primary active" id="account-tab"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link d-flex align-items-center text-primary" id="password-tab"
                                            data-toggle="tab" href="#password" aria-controls="password" role="tab"
                                            aria-selected="false">
