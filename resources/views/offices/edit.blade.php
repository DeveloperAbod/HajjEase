...
@section('page_meta')
    ...
    <title>لوحة تحكم مكاتب الحج والعمرة | تعديل المكتب </title>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">تعديل المكتب</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">الصفحة الرئيسية</a></li>
                                <li class="breadcrumb-item active"><a href="{{ route('offices') }}">المكاتب</a></li>
                                <li class="breadcrumb-item active">تعديل: {{ $office->name }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        <form novalidate action="{{ route('offices.update', $office->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="location"
                                                                value="{{ $office->location }}" required
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="url" name="map_url"
                                                                value="{{ $office->map_url }}" class="form-control"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="phone"
                                                                value="{{ $office->phone }}" required minlength="9"
                                                                maxlength="9"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="contact_person"
                                                                value="{{ $office->contact_person }}" required
