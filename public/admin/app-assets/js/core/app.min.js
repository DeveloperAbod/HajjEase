  ...
  if (
    (a(e).on("load", function () {
      ...
      !1 === a.app.nav.initialized && a.app.nav.init({ speed: 300 }),
        ...
        setTimeout(function () {
          var e;
          a("body").hasClass("vertical-content-menu") &&
            ((e = a(".main-menu").height()),
            a(".content-body").height() < e &&
              a(".content-body").css("height", e));
        }, 500),
  ...
  a(n).on("click", ".menu-toggle, .modern-nav-toggle", function (n) {
    return (
      ...
      a(".user-profile .user-info .dropdown").hasClass("show") &&
        (a(".user-profile .user-info .dropdown").removeClass("show"),
        a(".user-profile .user-info .dropdown .dropdown-menu").removeClass(
          "show"
        )),
      a.app.menu.toggle(),
      setTimeout(function () {
    ...
    a(e).resize(function () {
      a.app.menu.manualScroller.updateHeight(),
        a(e).width() > 768 &&
          ...
          a(".search-input input").blur(),
          a(".search-input").removeClass("open"),
          a(".header-navbar").find(".search-list.show") &&
            a(".header-navbar").find(".search-list.show").removeClass("show"),
          a(".app-content").removeClass("show-overlay"));
    }),
