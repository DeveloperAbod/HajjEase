...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="/admin/app-assets/css-rtl/core/menu/menu-types/vertical-menu.min.css" />
    <link rel="stylesheet" type="text/css" href="/admin/app-assets/css-rtl/core/colors/palette-gradient.min.css" />
    <link rel="stylesheet" type="text/css" href="/admin/app-assets/css-rtl/pages/error.min.css" />
    <!-- END: Page CSS-->
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="col-lg-4 col-md-8 col-10 p-0">
                            <div class="card-header bg-transparent border-0">
                                <h2 class="error-code text-center mb-2">000</h2>
                                <h3 class="text-uppercase text-center">تم ايقاف حسابك</h3>
                                <h5 class="text-uppercase text-center">عذرا، حسابك موقوف مؤقتا يرجى مراجعة مدير النظام..
                                </h5>
                            ...
                            <div class="card-content">
                                <div class="row py-2">
                                    <div class="col-12 col-sm-12 col-md-12 mb-1">
                                        <a href="/login" class="btn btn-primary btn-block"><i class="ft-home"></i>
                                            الرجوع الى صفحة تسجيل الدخول</a>
                                    </div>
                            ...
                            <div class="card-footer bg-transparent">
                                <div class="row">
                                    <p class="text-muted text-center col-12 pb-1">
                                        مكاتب الحج والعمرة - صنعاء
                                        © <span class="year"></span>
                                        <a href="#">تم التصميم والتطوير
                                            <i class="ft-heart pink"> </i> من قبل
                                            <a href="https://devabod.pro" target="_blank">المطور عبود</a>
                                    </p>
                                </div>
                            </div>
                        </div>
