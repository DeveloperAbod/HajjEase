...
@section('page_meta')
    ...
    <title>
        لوحة تحكم مكاتب الحج والعمرة | اضافة صلاحية جديدة
    </title>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">اضافة صلاحية جديدة</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ Route('home') }}">الصفحة الرئيسية</a></li>
                                <li class="breadcrumb-item active"><a href="{{ Route('roles') }}">الصلاحيات</a></li>
                                        ...
                                        <form novalidate class="form" action="{{ Route('roles.store') }}" method="POST">
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="la la-check-square-o"></i>اضافة الصلاحية
                                                </button>
